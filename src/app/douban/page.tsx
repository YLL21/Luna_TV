    ...
    <PageLayout activePath={getActivePath()}>
      <div className='overflow-visible -mt-6 md:mt-0 pb-40 md:pb-safe-bottom'>
        ...
        <div className='mb-6 sm:mb-8 space-y-4 sm:space-y-6'>
          ...
          {/* 选择器组件 */}
          {type !== 'custom' ? (
            <div className='relative bg-white/80 dark:bg-gray-800/60 rounded-2xl p-4 sm:p-6 border border-blue-200/40 dark:border-blue-700/40 backdrop-blur-md shadow-lg hover:shadow-xl transition-all duration-300'>
              <div className='absolute -top-20 -right-20 w-40 h-40 bg-blue-300/20 rounded-full blur-3xl pointer-events-none'></div>
              <div className='absolute -bottom-20 -left-20 w-40 h-40 bg-green-300/20 rounded-full blur-3xl pointer-events-none'></div>
          ...
          {useVirtualization ? (
            <>
              ...
              {hasNextPage && !isLoading && (
                ...
                >
                  {isFetchingNextPage && (
                    <div className='relative px-8 py-4 rounded-2xl bg-green-50 dark:bg-green-900/20 border border-green-200/50 dark:border-green-700/50 shadow-lg backdrop-blur-sm overflow-hidden'>
              ...
              {!hasNextPage && allItems.length > 0 && (
                <div className='flex justify-center mt-8 py-8'>
                  <div className='relative px-8 py-5 rounded-2xl bg-blue-50 dark:bg-blue-900/20 border border-blue-200/50 dark:border-blue-700/50 shadow-lg backdrop-blur-sm overflow-hidden'>
              ...
              {!isLoading && selectorsReady && allItems.length === 0 && (
                <div className='flex justify-center py-16'>
                  <div className='relative px-12 py-10 rounded-3xl bg-gray-50 dark:bg-gray-800/40 border border-gray-200/50 dark:border-gray-700/50 shadow-xl backdrop-blur-sm overflow-hidden max-w-md'>
                    <div className='absolute top-0 left-0 w-32 h-32 bg-blue-200/20 rounded-full blur-3xl'></div>
                    <div className='absolute bottom-0 right-0 w-32 h-32 bg-pink-200/20 rounded-full blur-3xl'></div>
