  ...
  return (
    <PageLayout activePath='/source-browser'>
      <div className='max-w-7xl mx-auto space-y-6 -mt-6 md:mt-0 pb-40 md:pb-safe-bottom'>
        ...
        {/* Sources - 美化版 */}
        <div className='bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200/80 dark:border-gray-700/80 backdrop-blur-sm'>
            ...
            {loadingSources ? (
              ...
              <div className='flex flex-wrap gap-2.5'>
                {sources.map((s, index) => (
                  <button
                    ...
                    className={`group relative px-4 py-2.5 rounded-xl text-sm font-medium border-2 transition-all duration-300 transform hover:scale-105 ${
                      activeSourceKey === s.key
                        ...
                        : 'border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 hover:border-emerald-300 dark:hover:border-emerald-700'
                    }`}
                    style={{
                  ...
                  >
                    {activeSourceKey === s.key && (
                      <div className='absolute inset-0 rounded-xl bg-emerald-400 blur-lg opacity-50 -z-10'></div>
                    )}
                    {s.name}
                  </button>
                ))}
                ...
                <div className='flex flex-wrap gap-2.5'>
                  {loadingCategories ? (
                    ...
                    categories.map((c, index) => (
                      <button
                        ...
                        className={`group relative px-4 py-2 rounded-xl text-sm font-medium border-2 transition-all duration-300 transform hover:scale-105 ${
                          String(activeCategory) === String(c.type_id)
                            ...
                            : 'border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 hover:border-blue-300 dark:hover:border-blue-700'
                        }`}
                        style={{
                      ...
                      >
                        {String(activeCategory) === String(c.type_id) && (
                          <div className='absolute inset-0 rounded-xl bg-blue-400 blur-lg opacity-50 -z-10'></div>
                        )}
                        {c.type_name}
                      </button>
                    ))
                  ...
                  <>
                    <div className='grid gap-3 grid-cols-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6'>
                      {filteredAndSorted.map((item, index) => (
                        ...
                        >
                          {/* 发光效果 */}
                          <div className='absolute inset-0 bg-blue-500/0 group-hover:from-blue-500/10 group-hover:via-blue-500/5 group-hover:to-transparent transition-all duration-300 pointer-events-none z-10'></div>
        ...
        {previewOpen && (
          ...
          >
            <div
              className='w-full max-w-5xl bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh] md:max-h-[90vh] border-2 border-gray-200/50 dark:border-gray-700/50 animate-scaleIn'
            ...
            >
                    ...
                    <div className='md:col-span-1'>
                      <div className='md:sticky md:top-0'>
                        {previewItem?.poster ? (
                          ...
                          <div className='w-full max-w-[200px] mx-auto md:max-w-none aspect-[2/3] bg-gray-100 dark:bg-gray-700 rounded-xl md:rounded-2xl flex items-center justify-center border border-gray-200 dark:border-gray-700 md:border-2'>
              ...
              {/* 底部操作栏 */}
              <div className='px-5 sm:px-6 py-4 border-t border-gray-200 dark:border-gray-700 bg-white/90 dark:bg-gray-800/90 backdrop-blur-md flex items-center justify-between gap-3'>
                ...
                <div className='flex items-center gap-2 sm:gap-3'>
                  ...
                  <button
                    ...
                    className='group relative inline-flex items-center justify-center gap-2 px-4 sm:px-6 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 transition-all duration-300 hover:scale-105'
                  >
                    <div className='absolute inset-0 rounded-xl bg-blue-400 blur-lg opacity-0 group-hover:opacity-50 transition-opacity -z-10'></div>
