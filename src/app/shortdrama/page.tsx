...
export default function ShortDramaPage() {
          ...
          {!isSearchMode && categories.length > 0 && (
            <div className="mb-6">
              <div className="flex items-center space-x-2.5 mb-4">
                <div className="w-9 h-9 rounded-xl bg-purple-500 flex items-center justify-center shadow-lg shadow-purple-500/30">
              ...
              <div className="flex flex-wrap gap-2.5">
                {categories.map((category, index) => (
                  ...
                  >
                    ...
                    {/* 未激活状态的悬停背景 */}
                    {selectedCategory !== category.type_id && (
                      <div className="absolute inset-0 bg-purple-50 dark:bg-purple-900/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    )}
 ...
 虚拟滑动
              ...
              <div className='relative'>
                ...
                />
                <div className='w-11 h-6 bg-gray-200 rounded-full peer-checked:from-purple-400 peer-checked:to-pink-500 transition-all duration-300 dark:bg-gray-600 dark:peer-checked:from-purple-500 dark:peer-checked:to-pink-600 shadow-inner'></div>
 ...
 {useVirtualization ? '' : '○'}
          ...
          {(isLoading || isFetchingNextPage) && (
            <div className="mt-8">
              <div className="flex justify-center mb-6">
                <div className='flex items-center gap-3 px-6 py-3 bg-purple-50 dark:bg-purple-900/20 rounded-xl border border-purple-200/50 dark:border-purple-700/50 shadow-md'>
              ...
              <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6">
                {Array.from({ length: 12 }).map((_, index) => (
                  <div key={index} className="relative overflow-hidden">
                    <div className="aspect-[2/3] w-full rounded-lg bg-gray-100 dark:bg-gray-800">
                      <div className='absolute inset-0 -translate-x-full animate-[shimmer_2s_infinite] bg-transparent'></div>
                    </div>
                    <div className="mt-2 h-4 rounded bg-gray-100 dark:bg-gray-800 relative overflow-hidden">
                      <div className='absolute inset-0 -translate-x-full animate-[shimmer_2s_infinite] bg-transparent'></div>
                    </div>
                    <div className="mt-1 h-3 w-2/3 rounded bg-gray-100 dark:bg-gray-800 relative overflow-hidden">
                      <div className='absolute inset-0 -translate-x-full animate-[shimmer_2s_infinite] bg-transparent'></div>
                    </div>
                  </div>
                ))}
          ...
          {!isLoading && !hasNextPage && allDramas.length > 0 && (
            <div className='flex justify-center mt-12 py-8'>
              <div className='relative px-8 py-5 rounded-2xl bg-purple-50 dark:bg-purple-900/20 border border-purple-200/50 dark:border-purple-700/50 shadow-lg backdrop-blur-sm overflow-hidden'>
                {/* 装饰性背景 */}
                <div className='absolute inset-0 bg-purple-100/20 dark:bg-purple-800/10'></div>
          ...
          {!isLoading && allDramas.length === 0 && isSearchMode && (
            <div className='flex justify-center py-16'>
              <div className='relative px-12 py-10 rounded-3xl bg-gray-50 dark:bg-gray-800/40 border border-gray-200/50 dark:border-gray-700/50 shadow-xl backdrop-blur-sm overflow-hidden max-w-md'>
                {/* 装饰性元素 */}
                <div className='absolute top-0 left-0 w-32 h-32 bg-purple-200/20 rounded-full blur-3xl'></div>
                ...
                <div className='relative flex flex-col items-center gap-4'>
                  ...
                  <button
                    ...
                    className='mt-2 px-6 py-2.5 bg-blue-500 hover:bg-blue-600 text-white rounded-lg font-medium shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105'
                  >
                    清除搜索条件
                  </button>
