...
function LoginPageClient() {
  ...
  return (
    <div translate="no" className='fixed inset-0 z-50 flex items-center justify-center px-3 sm:px-4 py-8 sm:py-0 overflow-hidden bg-purple-100 dark:bg-gray-900'>
      ...
      >
        ...
        `}</style>
        {/* 装饰性光效 */}
        <div className='absolute -top-20 -left-20 w-40 h-40 bg-purple-400/30 rounded-full blur-3xl animate-pulse' />
        ...
        <div className='text-center mb-6 sm:mb-8'>
          <div className='inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 mb-3 sm:mb-4 rounded-xl sm:rounded-2xl bg-green-500 shadow-lg shadow-green-500/50 dark:shadow-green-500/30'>
            <Sparkles className='w-6 h-6 sm:w-8 sm:h-8 text-white' />
          </div>
          <h1 className='text-transparent bg-clip-text bg-green-600 dark:bg-green-400 tracking-tight text-3xl sm:text-4xl font-extrabold mb-2 drop-shadow-sm'>
            {siteName}
          </h1>
          ...
          {shouldAskUsername && (
            <div className='mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-200 dark:border-gray-700'>
              ...
              <Link
                href='/register'
                prefetch={true}
                className='group flex items-center justify-center gap-1.5 sm:gap-2 w-full px-4 sm:px-6 py-2 sm:py-2.5 rounded-lg bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800/50 text-green-700 dark:text-green-400 text-xs sm:text-sm font-semibold hover:bg-green-100 dark:hover:bg-green-900/30 hover:border-green-300 dark:hover:border-green-700 transition-all duration-300 hover:shadow-md hover:scale-[1.02] active:scale-100'
              >
 ...
 输入您的 Telegram 用户名（不含 @）
            ...
            <button
              ...
              className='group relative inline-flex w-full justify-center items-center gap-1.5 sm:gap-2 rounded-lg sm:rounded-xl bg-blue-600 hover:bg-blue-700 py-2.5 sm:py-3.5 text-sm sm:text-base font-semibold text-white shadow-lg shadow-blue-500/30 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/40 hover:-translate-y-0.5 disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:translate-y-0 disabled:hover:shadow-lg overflow-hidden active:scale-95'
            >
              <span className='absolute inset-0 w-full h-full bg-white/0 -translate-x-full group-hover:translate-x-full transition-transform duration-1000' />
