...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      {/* 微光背景效果 */}
      <div className='absolute inset-0 rounded-full bg-amber-400/0 group-hover:from-amber-400/20 group-hover:to-amber-600/20 dark:group-hover:from-amber-300/20 dark:group-hover:to-amber-500/20 transition-all duration-300'></div>
