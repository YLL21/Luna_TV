...
const CapsuleSwitch: React.FC<CapsuleSwitchProps> = ({
  ...
  return (
    ...
    <div
      ref={containerRef}
      className={`relative inline-flex bg-gray-200 dark:bg-gray-800 rounded-full p-1 shadow-lg${
        className || ''
      }`}
    >
      {/* 滑动的渐变背景指示器 */}
      {indicatorStyle.width > 0 && (
        <div
          className='absolute top-1 bottom-1 bg-blue-500 dark:bg-blue-600 rounded-full shadow-xl transition-all duration-300 ease-out'
          style={{
